...
Shader "waterfall test"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float2 panner2 = ( uv_TexCoord4 + 1.0 * _Time.y * float2( -0.5,0 ));
			float2 uv_TexCoord5 = i.uv_texcoord * float2( 1,1 ) + Offset15;
			float2 panner6 = ( uv_TexCoord5 + 1.0 * _Time.y * float2( -0.7,0 ));
			float2 uv_TexCoord9 = i.uv_texcoord * float2( 1,1 ) + Offset15;
			float2 panner10 = ( uv_TexCoord9 + 1.0 * _Time.y * float2( -1,0 ));
...
/*ASEBEGIN
Version=14401
7;29;1522;788;1452.431;-68.22888;1.347312;True;False
...
Node;AmplifyShaderEditor.PannerNode;2;37.23271,294.3544;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;-0.5,0;False;1;FLOAT;1.0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;10;3.248263,959.7203;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;-1,0;False;1;FLOAT;1.0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;11;359.4026,900.8516;Float;True;Property;_TextureSample2;Texture Sample 2;6;0;Create;True;29c0d31300cb5d94ca3e4a7f307bb168;ccbc0d11387ab264ea355cf30c0c45de;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;6;-10.00165,606.1368;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;-0.7,0;False;1;FLOAT;1.0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;1;358.0806,305.2783;Float;True;Property;_TextureSample0;Texture Sample 0;8;0;Create;True;7f7f573fab2c196429373b7d5a9727d5;ccbc0d11387ab264ea355cf30c0c45de;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;7;306.9981,615.1368;Float;True;Property;_TextureSample1;Texture Sample 1;7;0;Create;True;7f7f573fab2c196429373b7d5a9727d5;ccbc0d11387ab264ea355cf30c0c45de;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=EDBCD301F9B83B3E36FFA3A2A6B0EB15AEEBE333